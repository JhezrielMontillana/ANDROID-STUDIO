...
public class Announcement {
    ...
    public JSONArray totalHearts;
    public List<Comment> comments;
    private Context context;
    private Tool TOOL;

    public Announcement(Context context, User user, Bundle announcementObj, List<Comment> comments, JSONArray totalHearts) {
    ...
    public void Heart(String addOrRemove, Response.Listener listener) {
        Heart(addOrRemove, listener, new Response.ErrorListener() {
            @Override
